...
function limpiarCookies() {
  ...
  // Borrar localStorage de supabase
...
export default function LoginPage() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true)
    setError('')
    limpiarCookies() // limpiar sesión vieja antes de ingresar
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            background: 'transparent', color: limpiado ? 'var(--green)' : 'var(--text3)',
            border: 'none', borderRadius: '10px', fontSize: '13px',
            cursor: 'pointer',
          }}
        >
          {limpiado ? '✓ Sesión limpiada — intentá ingresar' : '¿Problemas para ingresar? Tocá acá'}
        </button>
      </div>
    </div>
  )
